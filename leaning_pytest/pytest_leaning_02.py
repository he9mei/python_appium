...
-->pytest
当前路径下的用例全部执行
leaning_pytest/test_01.py ..                                                                                                       [ 50%]
leaning_pytest/test_02.py ..
...
-->pytest leaning_pytest/test_01.py
执行指定路径/指定py文件
如果不想执行某些类或者函数，可标记跳过，在该类或函数前加上：@pytest.mark.skip

-->pytest leaning_pytest/test_01.py::TestDemo
执行指定路径/指定py文件::指定class

-->pytest leaning_pytest/test_01.py::TestDemo::test_test1
...
-v
加上-v可以看到每个函数的执行结果。如，
pytest -v leaning_pytest/test_01.py
结果为：
