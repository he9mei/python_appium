...
'''
以上实例执行结果：
leaning_pytest/test_10_xfail.py::TestXfail::test_01 标记失败---结果是成功
XPASS
leaning_pytest/test_10_xfail.py::TestXfail::test_02 标记失败---结果是失败
XFAIL
leaning_pytest/test_10_xfail.py::TestXfail::test_03 不会标记失败---结果是成功
PASSED
leaning_pytest/test_10_xfail.py::TestXfail::test_04 不会标记失败---结果是失败
FAILED
